...
**Print the evidence.** One line naming what in the record shows this
reader's state — what they are assumed to already know, what the source does
not bother explaining. Assuming prior purchase needs evidence of prior
purchase; without it the honest answer is `prospect`.
