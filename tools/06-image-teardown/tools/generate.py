...
The original is kept verbatim at `image-teardown/tools/superseded/generate.py` so an old run's records still read.
Nothing imports it.
...
sys.exit(
    ...
    "  variations:  image-production/tools/make_variations.py\n"
    "  one edit:    image-production/tools/hf.py edit\n"
    "The original is parked at image-teardown/tools/superseded/generate.py.")
