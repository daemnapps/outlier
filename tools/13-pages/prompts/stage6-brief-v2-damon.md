...
- **Whose voice it is in** — the narrator persona, and that she is a cast persona and not a customer. **The narrator is never the source page's byline.** The swipe's writer is theirs; ours is whoever triage and the page itself bound the voice to. If the page's own byline slot is unfilled, say `narrator: unnamed first-person — cast persona to be chosen` and carry the byline decision into BEFORE YOU BUILD IT.
