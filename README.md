...
| **05** | **The portal** — where the ad click lands. A place your customer already knows, rebuilt from the brand folder and played first person like a mission: look around, walk to the marker, take the wheel. The store learns what a quiz would have asked. Player included. | [`tools/05-portal/`](tools/05-portal/) · [walk through it](https://daemn.co/portal/) | [zip](https://daemn.co/downloads/portal-kit.zip) |
